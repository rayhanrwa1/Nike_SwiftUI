...
struct DetailScreen5: View {
    ...
    var body: some View {
        ZStack {
            ...
            .cornerRadius3(60.0, corners: .topLeft)
...
extension View {
    func cornerRadius4(_ radius: CGFloat, corners: UIRectCorner) -> some View {
        clipShape( RoundedCorner5(radius: radius, corners: corners) )
    }
}

struct DetailScreen_Previews5: PreviewProvider {
...
struct DescriptionView5: View {
    var body: some View {
            ...
            HStack {
                VStack (alignment: .leading) {
                    Text("Colors")
                        .fontWeight(.semibold)
                    HStack {
                        ColorDotView5(color: Color.white)
                        ColorDotView5(color: Color.black)
                        ColorDotView5(color: Color(#colorLiteral(red: 0.1803921569, green: 0.6352941176, blue: 0.6705882353, alpha: 1)))
                    }
                }
                .frame(maxWidth: .infinity, alignment: .leading)
                ...
                HStack {
                    ...
                    .overlay(RoundedCorner5(radius: 50).stroke())
        ...
        .padding(.top)
        .background(Color("Bg"))
        .cornerRadius4(30, corners: [.topLeft, .topRight])
        .offset(x: 0, y: -30.0)
    }
}


struct BackButton5: View {
    let action: () -> Void
    var body: some View {
