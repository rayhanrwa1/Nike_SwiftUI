...
extension View {
    func cornerRadius5(_ radius: CGFloat, corners: UIRectCorner) -> some View {
        clipShape( RoundedCorner4(radius: radius, corners: corners) )
    }
}

struct DetailScreen_Previews4: PreviewProvider {
            ...
            HStack {
                VStack (alignment: .leading) {
                    Text("Colors")
                        .fontWeight(.semibold)
                    HStack {
                        ColorDotView4(color: Color.white)
                        ColorDotView4(color: Color.black)
                        ColorDotView4(color: Color(#colorLiteral(red: 0.1803921569, green: 0.6352941176, blue: 0.6705882353, alpha: 1)))
                    }
                }
                .frame(maxWidth: .infinity, alignment: .leading)
                ...
                HStack {
                    ...
                    .overlay(RoundedCorner4(radius: 50).stroke())
