...
struct DetailScreen: View {
    ...
    var body: some View {
        ...
        .navigationBarItems(leading: BackButton1(action: {presentationMode.wrappedValue.dismiss()}), trailing: Image(""))
    }
}
...
struct DetailScreen_Previews1: PreviewProvider {
...
struct DescriptionView1: View {
    var body: some View {
        VStack (alignment: .leading) {
            //                Title
            Text("Nike Air Max 90 GORE-TEX")
                .font(.title)
                .fontWeight(.bold)
            //                Rating
            HStack (spacing: 4) {
            ...
            HStack {
                VStack (alignment: .leading) {
                    Text("Colors")
                        .fontWeight(.semibold)
                    HStack {
                        ColorDotView1(color: Color.white)
                        ColorDotView1(color: Color.black)
                        ColorDotView1(color: Color(#colorLiteral(red: 0.1803921569, green: 0.6352941176, blue: 0.6705882353, alpha: 1)))
                    }
                }
                .frame(maxWidth: .infinity, alignment: .leading)
                ...
                HStack {
                    ...
                    .overlay(RoundedCorner1(radius: 50).stroke())
